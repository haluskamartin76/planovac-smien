...
uploaded_file = st.file_uploader("Nahraj databázu (databaza_pozicii.xlsx)", type="xlsx")
...
if uploaded_file:
    ...
    st.subheader("Uprav absencie pre vybraný mesiac")
    ...
    st.info("Nahrajte súbor 'databaza_pozicii.xlsx' pre začatie plánovania.")
