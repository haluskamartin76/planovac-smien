...
# --- 2. GENEROVANIE (TVOJA KOMPLETNÁ LOGIKA A VIZUÁL) ---
def generuj_final(m, r, fond_limit, parl_active, p_from, p_to, df_v_list, use_extra_w, df_db):
    ...
    for d in range(1, days_count + 1):
        ...
        for smena in ['D', 'N']:
            ...
            # Špeciálne pozície (Parlament, W, M)
